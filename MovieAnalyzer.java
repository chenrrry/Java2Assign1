...
public class MovieAnalyzer {
    ...
    public Map<Integer, Integer> getMovieCountByYear(){
        Map<Integer, List<Movie>> map1 = listOfMovie.stream().collect(Collectors.groupingBy(Movie::get_Released_Year));
        Set<Map.Entry<Integer, List<Movie>>> entries1 = map1.entrySet();
        Map<Integer, Integer> map2 = new TreeMap<>((Comparator<Object>) (o1, o2) -> -((Integer) o1).compareTo((Integer) o2));
    ...
    public Map<String, Integer> getMovieCountByGenre(){
        Map<String, List<Movie>> map1 = listOfMovie.stream().collect(Collectors.groupingBy(Movie::get_Genre));
    ...
    public List<String> getTopMovies(int top_k, String by){
        ...
        if(by.equals("runtime")){
            ...
            list.sort(Comparator.comparing(Movie::get_runtime_int).thenComparing(Movie::get_Series_Title));
        }else {
            list=list.stream()
                    .filter(l -> !l.get_runtime().equals(""))
                    .collect(Collectors.toList());
            list.sort(Comparator.comparing(Movie::get_overview).thenComparing(Movie::get_Series_Title));
        }
        list=list.stream()
                .limit(top_k)
                .collect(Collectors.toList());
